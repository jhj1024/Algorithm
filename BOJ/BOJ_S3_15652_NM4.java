...
* [고려사항] 
* [입력사항] 자연수 N과 M
* [출력사항] 1부터 N까지 자연수 중에서 M개를 고른 조합(중복 허용)
* 
* 설명에는 중복을 허용하는 순열이라고 하지만, 순열 내 요소가 오름차순이어야 하기 때문에 순서가 정해져있는 조합이다.
* 수열은 사전 순으로 증가하는 순서로 출력
*/

public class BOJ_S3_15652_NM4 {
